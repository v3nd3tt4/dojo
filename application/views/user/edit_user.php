            ...
            <form id="frm_tambah_user" enctype="multipart/form-data" method="POST" action="<?=base_url()?>admin/tambahAdmin">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" value="<?=@$row->row()->username?>" required readonly />
                    </div>
            		<div class="form-group">
            			<label>Nama:</label>
            			<input type="text" name="nama" class="form-control" value="<?=@$row->row()->nama?>" required />
            		</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="level" class="form-control" required >
                            ...
                            <option value="guest" <?=@$row->row()->level == 'guest'? 'selected' : ''?>>guest</option>
                            <option value="admin" <?=@$row->row()->level == 'admin'? 'selected' : ''?>>admin</option>
                            <option value="master" <?=@$row->row()->level == 'guest'? 'selected' : ''?>>master</option>
                        </select>
                    </div>
